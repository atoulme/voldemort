...
public class AvroGenericSerializer implements Serializer<Object> {
    ...
    public byte[] toBytes(Object object) {
        ...
        try {
            ...
            DatumWriter<Object> datumWriter = null;
    ...
    public Object toObject(byte[] bytes) {
        ...
        try {
            ...
            datumReader = new GenericDatumReader<Object>(typeDef);
     ...
     * @author antoine
     */
    private class SeekableByteArrayInput extends ByteArrayInputStream implements SeekableInput {
